...
def compare_versions(local, remote):
    ...
    # Debugging output
    print(f"[Mektools] Local version: {local_version} ({local_feature}.{local_feature_patch})")
    print(f"[Mektools] Remote version: {remote_version} ({remote_feature}.{remote_feature_patch})")
    print(f"[Mektools] Update available: {update_available}")
